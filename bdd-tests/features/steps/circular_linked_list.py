...
@when('I run circular linked list function "{function_name}" with input:')
def step_run_circular_linked_list_function(context, function_name):
...
def step_validate_circular_linked_list_output(context):
