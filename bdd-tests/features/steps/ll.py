...
@when('I run linked list function "{function_name}" with input:')
def step_run_linked_list_function(context, function_name):
...
def step_validate_linked_list_output(context):
